    ...
    <div class="container-fluid fs-5">
      <div class="row text-center">
        ...
        <div class="col-sm p-0 d-none d-sm-block">
          <RouterLink class="nav-link" href=""
            >Twitter
            <i class="bi bi-twitter"></i>
          </RouterLink>
          <RouterLink class="nav-link" href=""
        ...
        <div class="col-sm p-0 d-none d-sm-block">
          <RouterLink class="nav-link" href=""> Impressum </RouterLink>
          <RouterLink class="nav-link" href=""> Datenschutz </RouterLink>
        </div>
      </div>
      <div class="d-flex justify-content-center align-items-center p-2">
        <img src="@/assets/Logo.png" alt="Logo" class="me-2" style="width: 50px" />
        WärmeSpenden e.V.
      </div>
    </div>
</template>
